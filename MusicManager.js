  ...
  _create_class(MusicManager, [
          ...
          return _ts_generator(this, function (_state) {
            switch (_state.label) {
              ...
              case 1:
                ...
                _this.stereoDelay = new Tone.FeedbackDelay("8n", 0.5).connect(
                  _this.reverb
                );
                ...
                _this.polySynth = new Tone.PolySynth(
                  Tone.FMSynth,
                  _this.synthPresets[_this.currentSynthIndex]
                );
                ...
                console.log(
                  "Tone.js AudioContext started and PolySynth is ready."
                );
                return [2];
            }
          });
    ...
    },
    {
      ...
      value: function startArpeggio(handId, rootNote) {
        ...
        var chord = Tone.Frequency(rootNote).harmonize([0, 3, 5, 7, 10, 12]);
    ...
    },
    {
      ...
      value: function cycleSynth() {
        ...
        this.currentSynthIndex =
          (this.currentSynthIndex + 1) % this.synthPresets.length;
        ...
        this.reverb.wet.value =
          (_newPreset_effects_reverbWet =
            (_newPreset_effects = newPreset.effects) === null ||
            _newPreset_effects === void 0
              ? void 0
              : _newPreset_effects.reverbWet) !== null &&
          _newPreset_effects_reverbWet !== void 0
            ? _newPreset_effects_reverbWet
            : 0.8; // Default to 0.8 if not specified
        var _newPreset_effects_delayWet;
        this.stereoDelay.wet.value =
          (_newPreset_effects_delayWet =
            (_newPreset_effects1 = newPreset.effects) === null ||
            _newPreset_effects1 === void 0
              ? void 0
              : _newPreset_effects1.delayWet) !== null &&
          _newPreset_effects_delayWet !== void 0
            ? _newPreset_effects_delayWet
            : 0; // Default to 0 if not specified
        console.log(
          "Switched to synth preset: ".concat(this.currentSynthIndex)
        );
      },
    },
    {
